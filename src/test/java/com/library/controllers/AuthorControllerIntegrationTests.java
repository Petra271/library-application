...
public class AuthorControllerIntegrationTests {
    ...
    public void testThatListAuthorsReturnsListOfAuthors() throws Exception {
        ...
        mockMvc.perform(
                ...
                MockMvcResultMatchers.jsonPath("$[0].name").value("Stephen King")
        ).andExpect(
    ...
    public void testThatGetAuthorReturnsHttpStatus404WhenNoAuthorExists() throws Exception {
        mockMvc.perform(
                MockMvcRequestBuilders.get("/authors/150")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    public void testThatFullUpdateAuthorReturnsHttpStatus404WhenNoAuthorExists() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.put("/authors/150")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    public void testThatFullUpdateUpdatesExistingAuthor() throws Exception {
        AuthorDto testAuthorDtoA = TestDataUtil.createTestAuthorDtoA();
        AuthorDto savedAuthor = authorService.save(testAuthorDtoA);
